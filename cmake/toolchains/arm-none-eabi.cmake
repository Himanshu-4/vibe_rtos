...
if(NOT DEFINED VIBE_CPU_FLAGS)
    ...
    elseif("${VIBE_BOARD}" STREQUAL "mps2_an386")
        set(VIBE_CPU_FLAGS "-mcpu=cortex-m4;-mfloat-abi=soft")
        message(STATUS "Toolchain: mps2_an386 → Cortex-M4, soft-float (QEMU emulation)")
    else()
        set(VIBE_CPU_FLAGS "-mcpu=cortex-m0plus;-mfloat-abi=soft")
